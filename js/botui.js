...
function bot_ui_ini() {
    ...
    var sure = function() {
        ...
        secondpart = function() {
            botui.message.add({
                delay: 1500,
                content: "本站始于2019年7月30号👻"
            }).then(function() {
                botui.message.add({
                    delay: 1200,
                    content: "目的是记录工作中遇到的问题以及 个人的无病呻吟~"
                }).then(function() {
                    botui.message.add({
                        delay: 5000,
                        content: "今天也没什么干劲 明天开始努力吧.jpg (#伸懒腰)..."
                    }).then(function() {
                        botui.action.button({
                            delay: 2000,
                            action: [{
                            ...
                            botui.message.add({
                                delay: 2200,
                                content: "宅、玩游戏(三分热度)、看动漫、思考鱼生ing...  绝对不会学习"
                            }).then(function(a) {
                                thirdpart()
                            })
                        })
        ...
        fourthpart = function() {
            botui.message.add({
                delay: 1E3,
                content: "Clannad、Fate、月色真美 "
            }).then(function() {
                botui.message.add({
                    delay: 1100,
                    content: "'把I Love You翻译成月色真美的究竟是太宰治还是夏目漱石呢'"
                }).then(function() {
                    botui.action.button({
                        delay: 1500,
                        action: [{
        ...
        fifthpart = function() {
            botui.message.add({
                delay: 1E3,
                content: "有样东西是其他生物绝对没有，只有人类才有，那就是人有秘密    ———太宰治/斜阳"
            }).then(function() {
                botui.message.add({
                    delay: 3600,
                    content: "emmm...欢迎与我  建♂交"
                }).then(function() {
                    botui.message.add({
                        delay: 4700,
                        content: "如果你喜欢我的博客的话，看到导航栏那个熟悉的 '赞赏' 标签了吗，点开它￣ω￣="
                    })
                })
            })
        }
