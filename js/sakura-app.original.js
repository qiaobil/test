...
function code_highlight_style() {
  function gen_top_bar(i) {
    ...
    $("pre:eq(" + i + ") code").attr("data-rel", lang);
  }
...
function checkBgImgCookie() {
  ...
  if (!bgurl) {
    $("#header").removeClass("banner_wave_hide_fit_skin");
  } else {
    $("#header").addClass("banner_wave_hide_fit_skin");
  }
  if (bgurl != "") {
    if (
      bgurl ==
...
var home = location.href,
  ...
  Siren = {
    ...
    splay: function () {
      ...
      $("#header").addClass("banner_wave_hide");
      s.play();
    },
    spause: function () {
      ...
      $("#header").removeClass("banner_wave_hide");
      s.pause();
    },
    liveplay: function () {
