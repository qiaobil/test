...
!(function(n, e) {
        ...
        if (("" === t[t.length - 1].trim() && t.pop(), t.length > e)) {
            for (var r = "", l = 0, i = t.length; l < i; l++)
                r += h(
                    ...
                    [v, g, m, j, p, l + 1, t[l].length > 0 ? t[l] : " "]
                );
    ...
    var f = "hljs-ln",
        ...
        L = /\r\n|\r|\n/g;
    n.hljs ?
        ((n.hljs.initLineNumbersOnLoad = r), (n.hljs.lineNumbersBlock = i), t()) :
    ...
    var l = (function() {
        ...
        f = (function() {
            ...
            function e(n) {
                ...
                if (n in e) return n;
                for (
                    var t, r = i.length, s = n.charAt(0).toUpperCase() + n.slice(1); r--;
                    ...
                    [{
                        ...
                        },
                        {
                            ...
                            value: function() {
                                ...
                                for (
                                    var e = this.placeholder[0].parentNode; null !== e && !t(e).is(document);
                ...
                _createClass(
                    ...
                    [{
                        ...
                        },
                        {
                            ...
                            value: function(i) {
                                for (
                                    var n = t(i.target), o = s._elements.length - 1; o >= 0; o--
                                ) {
                                    var a = s._elements[o];
                ...
                _createClass(
                    ...
                    [{
                        ...
                        },
                        {
                            ...
                            value: function() {
                                for (
                                    var e = t('<div class="timepicker-tick"></div>'), i = 0; i < 60; i += 5
                                ) {
                                    var s = e.clone(),
                                        o = (i / 30) * Math.PI;
                                    s.css({
                    ...
                    [{
                        ...
                        },
                        {
                            ...
                            value: function() {
                                ...
                                if (!e)
                                    for (
                                        var i = this.$origin.parents(), n = 0; n < i.length && !(e = "fixed" == t(i[n]).css("position")); n++
                                    );
...
function get_gravatar(email, size) {
    ...
    var size = size || 80;
    return (
        "https://gravatar.shino.cc/avatar/" +
        MD5(email) +
        ".jpg?s=" +
        size +
        "&d=mm"
    ...
    !(function() {
        ...
        (e.prototype = {
            ...
            setupPositionAdjustPattern: function() {
                for (
                    var t = u.getPatternPosition(this.typeNumber), e = 0; e < t.length; e++
                )
            ...
            setupTypeNumber: function(t) {
                for (
                    var e = u.getBCHTypeNumber(this.typeNumber), r = 0; r < 18; r++
                ) {
                    i = !t && 1 == ((e >> r) & 1);
        ...
        (e.createData = function(t, r, o) {
            for (
                var a = i.getRSBlocks(t, r), s = new n(), h = 0; h < o.length; h++
            ) {
                var l = o[h];
                s.put(l.mode, 4),
            ...
            if (s.getLengthInBits() > 8 * c)
                throw new Error(
                    "code length overflow. (" + s.getLengthInBits() + ">" + 8 * c + ")"
                );
            for (
                s.getLengthInBits() + 4 <= 8 * c && s.put(0, 4); s.getLengthInBits() % 8 != 0;
            ...
            var s = {
                ...
                u = {
                    ...
                    getBCHTypeInfo: function(t) {
                        for (
                            var e = t << 10; u.getBCHDigit(e) - u.getBCHDigit(u.G15) >= 0;
                    ...
                    getBCHTypeNumber: function(t) {
                        for (
                            var e = t << 12; u.getBCHDigit(e) - u.getBCHDigit(u.G18) >= 0;
        ...
        (r.prototype = {
            ...
            multiply: function(t) {
                for (
                    var e = new Array(this.getLength() + t.getLength() - 1), i = 0; i < this.getLength(); i++
                )
        ...
        (i.getRSBlocks = function(t, e) {
            ...
            for (var n = r.length / 3, o = [], a = 0; a < n; a++)
                for (
                    var s = r[3 * a + 0], h = r[3 * a + 1], l = r[3 * a + 2], u = 0; u < s; u++
                )
                    o.push(new i(h, l));
            return o;
        }),
                ...
                (function(t, e) {
                    ...
                    h(n ? i.reverse() : i, function(i) {
                        var o = (function(t, e) {
                            ...
                            h = e.initialized ?
                            a(t, "icon-" + i) :
                            s('<a class="social-share-icon icon-' + i + '"></a>');
                        ...
                        "wechat" === i
                            ...
                            e.initialized ||
                            (n ?
                                t.insertBefore(h[0], t.firstChild) :
                                t.appendChild(h[0]));
                    });
                })(t, i),
                (function(t, e) {
...
var baguetteBox = (function() {
    ...
    function l(t) {
        ...
        if (t.dataset) {
            ...
            for (
                var o = window.innerWidth * window.devicePixelRatio, a = 0; a < keys.length - 1 && keys[a] < o;
